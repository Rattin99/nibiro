    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-6">
        <a href="mailto:contact@nibiro.org" className="group block">
          <div className="bg-blue-500 border-2 border-black rounded-xl p-6 flex items-center gap-6 transition-all duration-300 hover:bg-blue-700 hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
            ...
            <div>
              <h4 className="font-bold text-gray-800 uppercase text-xs tracking-wider mb-1">
                Email Us
              </h4>
              <p className="font-black text-xl md:text-2xl font-montserrat">
                contact@nibiro.org
              </p>
            </div>
          </div>
        ...
        <a href="tel:+8801234567890" className="group block">
          <div className="bg-green-500 border-2 border-black rounded-xl p-6 flex items-center gap-6 transition-all duration-300 hover:bg-green-700 hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
            ...
            <div>
              ...
              <p className="text-gray-800 font-black text-xl md:text-2xl font-montserrat">
                +880 1234 567 890
              </p>
            </div>
          </div>
      ...
      <div className="bg-white border-2 border-black rounded-xl p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
        <div className="flex items-center gap-4 mb-6">
          ...
          <h3 className="text-2xl font-black font-montserrat">
            HQ Coordinates
          </h3>
        </div>
        ...
        <div className="w-full h-48 bg-neutral-200 border-2 border-black rounded-lg relative overflow-hidden group cursor-pointer">
          <div className="absolute inset-0 flex items-center justify-center bg-neutral-300 group-hover:bg-neutral-200 transition-colors">
            <span className="font-mono text-neutral-500 font-bold">
              [ Map View Unavailable in Offline Mode ]
            </span>
          </div>
          {/* Map Marker Pin */}
      ...
      <div className="flex justify-between gap-4">
        <a
          href="#"
          className="flex-1 bg-black text-white py-4 rounded-xl border-2 border-transparent hover:bg-white hover:text-black hover:border-black hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all duration-300 flex justify-center items-center text-2xl"
        >
          <FaDiscord />
        </a>
        <a
